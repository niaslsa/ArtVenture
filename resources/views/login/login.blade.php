        ...
        <div class="card shadow-2-strong " 
          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="form-outline mb-4">
              <input type="text" id="typeEmailX-2" class="form-control form-control-lg" placeholder="Input your username here..." 
            ...
            <div class="form-outline mb-4">
              <input type="password" id="typePasswordX-2" class="form-control form-control-lg" placeholder="Input your password here..." 
              style="border-radius: 3rem; 
              height: 65px; 
              background-color: rgba(217, 217, 217, 1);"/>
            ...
            <p></p>
            <p></p>
            <img src="{{asset('img/loginpict.png')}}" alt="" style="width: 450x; height: 250px;">
          </div>
        </div>
      </div>
    </div>
