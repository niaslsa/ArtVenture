...
@section('title', 'Data Staff Tiketing')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="">
                ...
                <hr>
                <a href="/stafftiketing/tambah" style="margin-bottom: 10px">
                    <button class="btn btn-lg btn-success mb-4">Tambah Data Staff Tiketing</button>
                </a>
                        ...
                        @foreach ($StaffTiketing as $l)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="stafftiketing/edit/{{ $l->id_st }}">
    ...
    <script type="module">
        $('tbody').on('click', '.btnHapus', function(a) {
            a.preventDefault();
            let idST = $(this).closest('.btnHapus').attr('idST');
            swal.fire({
